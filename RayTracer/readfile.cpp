        ...
        if (cmd == "light") {
          if (numused == numLights) { // No more Lights 
            ...
            if (validinput) {
              ...
              //values[0] to values[ 3 ] hold a single light position corrsesponding to 4 vector coordinates
              ...
              //make good use of numused variable when saving light position and color to their respective array indexes
                for (i = 0; i < 4; i++) {
                    lightposn[(numused * 4) + i] = values[i]; //light 1
                }
                for (i = 4; i < 8; i++){
                    lightcolor[(numused * 4) + i -4] = values[i]; //light 2
                }
            //values[4] to values[7] light color by analogy
              ++numused; 
            }
          }
        }
        ...
        // Note that no transforms/stacks are applied to the colors. 
          ...
          if (validinput) {
            ...
            // Set eyeinit upinit center fovy in variables.h
              // camera lookfromx lookfromy lookfromz lookatx lookaty lookatz upx upy upz fovy specifies the camera in the standard way.
              eyeinit = vec3(values[0], values[1], values[2]);
              center = vec3(values[3], values[4], values[5]);
              
              //Transform::upvector(const vec3 &up, const vec3 & zvec)
        ...
        // Also look at demo.txt to get a sense of why things are done this way.
          ...
          if (validinput) {
            ...
            // Also keep in mind what order your matrix is!
              ...
              //Transform::translate(const float &tx, const float &ty, const float &tz)
          ...
          if (validinput) {
            ...
            //Transform::scale(const float &sx, const float &sy, const float &sz)
          ...
          if (validinput) {
            ...
            // Also keep in mind what order your matrix is!
              ...
              // Transform::rotate(const float degrees, const vec3& axis)
              vec3 axis = vec3(values[0], values[1], values[2]);
              mat3 tempRot = Transform::rotate(values[3], axis);
              mat4 rot = mat4(tempRot);
